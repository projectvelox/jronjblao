...
<div class="form-container">
    <form id="form_edit_customer">    
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <input disabled name="c_firstname" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_firstname'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Middle Name</span>
            <input disabled name="c_middlename" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_middlename'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Last Name</span>
            <input disabled name="c_lastname" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_lastname'];?>" required>
        </div>
        <div class="col-xs-2 col-md-2 col-lg-2">
            <span class="mesmer-form-label label-block">Gender</span>
            <select disabled name="c_gender" id="c_gender" class="form-control input-md field_input">
                <?php
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <select disabled  name="c_civil_status" id="c_civil_status" class="form-control input-md field_input">
            <?php
                echo "<option value=''></option>";
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <select disabled  name="c_area" id="c_area" class="form-control input-md field_input">
            <?php
                echo "<option value='' selected></option>";
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <select disabled name="c_branch_id" id="c_branch_id" class="form-control input-md field_input">
            <?php
                echo "<option value=''></option>";
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <input disabled name="c_phone_home" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_phone_home'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Office Phone</span>
            <input disabled name="c_phone_office" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_phone_office'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Mobile Phone</span>
            <input disabled name="c_phone_mobile" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_phone_mobile'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Email</span>
            <input disabled name="c_email" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_email'];?>" required>
        </div>
        <div class="col-xs-2 col-md-2 col-lg-2">
            <span class="mesmer-form-label label-block">Birth Date</span>
            <input disabled name="c_birthdate" type="text" class="form-control input-md field_input date_input_lock" value="<?=$data[0]['c_birthdate'];?>" required>
        </div>
        <div class="col-xs-2 col-md-2 col-lg-2">
            <span class="mesmer-form-label label-block">Active</span>
            <select disabled name="c_active" id="c_active" class="form-control input-md field_input">
            <?php
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <select disabled name="c_citizenship" id="c_citizenship" class="form-control input-md field_input">
            <?php
                echo "<option value='' selected></option>";
        ...
        <div class="col-xs-6 col-md-6 col-lg-6">
            ...
            <input disabled name="c_address_street" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_address_street'];?>" required>
        </div>
        <div class="col-xs-6 col-md-6 col-lg-6">
            <span class="mesmer-form-label label-block">Town</span>
            <input disabled name="c_address_town" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_address_town'];?>" required>
        </div>
        <div class="col-xs-5 col-md-5 col-lg-5">
            <span class="mesmer-form-label label-block">City/Province</span>
            <input disabled name="c_address_city" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_address_city'];?>" required>
        </div>
        <div class="col-xs-2 col-md-2 col-lg-2">
            <span class="mesmer-form-label label-block">Zip Code</span>
            <input disabled name="c_address_zipcode" type="text" class="form-control input-md field_input" value="<?=$data[0]['c_address_zipcode'];?>" required>
        </div>
        <div class="col-xs-5 col-md-5 col-lg-5">
            <span class="mesmer-form-label label-block">Country</span>
            <select disabled name="c_address_country" id="c_address_country" class="form-control input-md field_input">
            <?php
                echo "<option value='' selected></option>";
                $query = "SELECT * FROM options_country ORDER BY value ASC";
                $recordset = mysql_query($query) or die('Query failed: ' . mysql_error());
...
<div class="form-footer">
    <button closewindow="off" class="form-button view-history-ci"><i class="fa fa-history" aria-hidden="true"></i> Credit History</button>

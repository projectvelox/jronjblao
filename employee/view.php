...
<div class="form-container">
    <form id="form_edit_employee">    
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <input disabled  name="e_firstname" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_firstname'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Middle Name</span>
            <input disabled name="e_middlename" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_middlename'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Last Name</span>
            <input disabled name="e_lastname" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_lastname'];?>" required>
        </div>

        <div class="col-xs-6col-md-6 col-lg-6">
            <span class="mesmer-form-label label-block">User Name</span>
            <input disabled name="e_username" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_username'];?>" required>
        </div>
        <div class="col-xs-6 col-md-6 col-lg-6">
            <span class="mesmer-form-label label-block">Password</span>
            <input disabled name="e_password" type="password" class="form-control input-md field_input" value="<?=$data[0]['e_password'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Branch</span>
            <select disabled name="e_branch_id" id="e_branch_id" class="form-control input-md field_input">
            <?php
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <select disabled name="e_designation_id" id="e_designation_id" class="form-control input-md field_input">
            <?php
                echo "<option value=''></option>";
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <select disabled name="e_department_id" id="e_department_id" class="form-control input-md field_input">
            <?php
                echo "<option value=''></option>";
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            ...
            <input disabled name="e_phone_home" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_phone_home'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Office Phone</span>
            <input disabled name="e_phone_office" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_phone_office'];?>" required>
        </div>    
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Mobile Phone</span>
            <input disabled name="e_phone_mobile" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_phone_mobile'];?>" required>
        </div>           
        <div class="col-xs-2 col-md-2 col-lg-2">
            <span class="mesmer-form-label label-block">Gender</span>
            <select disabled name="e_gender" id="e_gender" class="form-control input field_input">
            <?php
        ...
        <div class="col-xs-3 col-md-3 col-lg-3">
            ...
            <select disabled name="e_marital_status_id" id="e_marital_status_id" class="form-control input-md field_input">
            <?php
                echo "<option value=''></option>";
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <input disabled name="e_birthdate" type="text" class="form-control input-md field_input date_input_lock" value="<?=$data[0]['e_birthdate'];?>" required>
        </div>
        <div class="col-xs-2 col-md-2 col-lg-2">
            <span class="mesmer-form-label label-block">Hide Date</span>
            <input disabled name="e_hiredate" type="text" class="form-control input-md field_input date_input_lock" value="<?=date('m/d/Y',strtotime($data[0]['e_hiredate']));?>" required>
        </div>
        <div class="col-xs-3 col-md-3 col-lg-3">
            <span class="mesmer-form-label label-block">Passport</span>
            <input disabled name="e_passport" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_passport'];?>" required>
        </div>
        <div class="col-xs-3 col-md-3 col-lg-3">
            <span class="mesmer-form-label label-block">Driver License</span>
            <input disabled name="e_driverlicense" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_driverlicense'];?>" required>
        </div>
        <div class="col-xs-3 col-md-3 col-lg-3">
            <span class="mesmer-form-label label-block">Philhealth</span>
            <input disabled name="e_philhealth" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_philhealth'];?>" required>
        </div>
        <div class="col-xs-3 col-md-3 col-lg-3">
            <span class="mesmer-form-label label-block">SSS Number</span>
            <input disabled name="e_sssno" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_sssno'];?>" required>
        </div>
        <div class="col-xs-3 col-md-3 col-lg-3">
            <span class="mesmer-form-label label-block">TIN No.</span>
            <input disabled name="e_tinno" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_tinno'];?>" required>
        </div>
        <div class="col-xs-6 col-md-6 col-lg-6">
        ...
        <div class="col-xs-6 col-md-6 col-lg-6">
            ...
            <input disabled name="e_address_street" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_address_street'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Town</span>
            <input disabled name="e_address_town" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_address_town'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">City/Province</span>
            <input disabled name="e_address_city" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_address_city'];?>" required>
        </div>
        <div class="col-xs-4 col-md-4 col-lg-4">
            <span class="mesmer-form-label label-block">Zip Code</span>
            <input disabled name="e_address_zipcode" type="text" class="form-control input-md field_input" value="<?=$data[0]['e_address_zipcode'];?>" required>
        </div>

        <div class="col-xs-3 col-md-3 col-lg-3">
            <span class="mesmer-form-label label-block">Country</span>
            <select disabled name="e_address_country" id="e_address_country" class="form-control input-md field_input">
            <?php
                echo "<option value='' selected></option>";
        ...
        <div class="col-xs-3 col-md-3 col-lg-3">
            ...
            <select disabled name="e_citizenship" id="e_citizenship" class="form-control input-md field_input">
            <?php
                echo "<option value='' selected></option>";
                $query = "SELECT * FROM options_country ORDER BY value ASC";
                $recordset = mysql_query($query) or die('Query failed: ' . mysql_error());
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <select disabled name="e_is_salesagent" id="e_is_salesagent" class="form-control input-md field_input">
            <?php
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <select disabled name="e_is_collector" id="e_is_collector" class="form-control input-md field_input">
            <?php
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <select disabled name="e_active" id="e_active" class="form-control input-md field_input">
            <?php

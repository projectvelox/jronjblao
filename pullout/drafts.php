...
<?php 
    ...
    $query_main = "SELECT 
                    ...
                    FROM pullout_main WHERE p_status='D' ORDER BY p_date ASC";
    ...
    $("#dbgrid").jsGrid({
        ...
        fields: [
            ...
            {   
                ...
                itemTemplate: function(value,e) { return $("<div>").append('<div><span data-id="'+e.p_id+'" class="grid-link pullout-edit">'+e.p_no+'</span></div>'); },                
            }, 

...
<div class="form-container bg-lightgray" height="536" width="800" uuid="">
    <form id="form_editpulloutlog"> 
        ...
        <div class="col-lg-2">
            ...
            <input name="p_date" type="text" value="<?=formatdate($data[0]["p_date"]);?>" class="field-input-block-thin">
        </div>
        <div class="col-lg-2">
        ...
        <div class="col-lg-3">
            ...
            <select name="p_attestedby_id" id="p_attestedby_id" class="field_input">
            <?php
        ...
        <div class="col-lg-3">
            ...
            <select name="p_inventoryby_id" id="p_inventoryby_id" class="field_input">
            <?php
                echo "<option value=''></option>";
                $query = "SELECT * FROM employees WHERE e_is_deleted='N' ORDER BY e_lastname ASC, e_firstname ASC";
                $recordset = mysql_query($query) or die('Query failed: ' . mysql_error());
        ...
        <div class="col-lg-12">
            ...
            <input name="p_notes" type="text" value="<?=$data[0]["p_notes"];?>" class="field-input-block-thin">
        </div> 
    </form>
</div>
<div class="form-footer">
    <button closewindow="off" class="form-button pullout_add_item"><i class="fa fa-plus" aria-hidden="true"></i> Add Item</button>
    <button closewindow="off" class="form-button pullout_delete_item"><i class="fa fa-trash" aria-hidden="true"></i> Delete Item</button>&nbsp;&nbsp;
    <button closewindow="off" class="form-button pullout_update"><i class="fa fa-check" aria-hidden="true"></i> Update</button>
    ...
    $("#dbgrid-tranferitems").jsGrid({
        ...
        fields: [
            {   
                ...
                itemTemplate: function(value,e) { return $("<div>").append('<div><input type="radio" name="parts_selected" value="'+e.p_sub_id+'"></div>'); },
            },            

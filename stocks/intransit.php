...
<?php 
    ...
    $query = "SELECT *,
                ...
                (SELECT b_name FROM branches WHERE branches.b_id=inventory.p_branch_id) AS p_branch                FROM inventory WHERE p_istransfer='Y' AND p_branch_id=".$_SESSION['branch_id']." ORDER BY p_recieved_date ASC";

    ...
    <form id="form_collection"> 
        ...
        <div class="col-lg-12">
            <div class="col-lg-3">
                ...
                <input disabled name="p_date" name="p_date" type="text" value="<?=date('m/d/Y');?>" class="field_readonly_block">
            </div>
            <div class="col-lg-3">
                <span class="label-block">OR Number</span>
                <input fname="p_or" name="p_or" type="text" value="" class="field-input-block-thin">
            </div>

            <div class="col-lg-3">
                <span class="label-block">Collection Amount</span>
                <input name="p_amount" name="p_amount" type="number" value="0" class="field-input-block-thin">
            </div>
            <div class="col-lg-3">
                <span class="label-block">Rebate</span>
                <input name="p_rebate" name="p_rebate" type="number" value="0" class="field-input-block-thin">
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                ...
                <textarea name="p_notes" rows="4" cols="50" class="textarea-remarks-input" style="height: 129px"></textarea>
            </div> 
        </div>        
    </form>
</div>
<div class="form-footer">
    <button closewindow="off" class="form-button create-collection"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
    <button class="form-button close-new-collection-form"><i class="fa fa-times" aria-hidden="true"></i> Close</button>
</div>
<script>

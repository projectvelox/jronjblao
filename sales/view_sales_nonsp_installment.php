...
?>
<div class="form-container bg-lightgray" height="549" width="835" uuid="">
    <form id="form_sales"> 
        ...
        <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <span class="label-block align-text">Tax</span>
                <input disabled name="s_tax" type="number" value="<?=$data_sales[0]['s_tax'];?>" class="field_readonly_block">
            </div>
            <div class="col-lg-4">
                <span class="label-block align-text">Other Charges</span>
                <input disabled name="s_othercharges" type="number" value="<?=$data_sales[0]['s_othercharges'];?>" class="field_readonly_block">
            </div>
            <div class="col-lg-4">
                <span class="label-block align-text">Discount</span>
                <input disabled name="s_discount" type="number" value="<?=$data_sales[0]['s_discount'];?>" class="field_readonly_block">
            </div>
            <div class="col-lg-12">
                <span class="label-block">Notes</span>
                <textarea disabled name="s_notes" rows="4" cols="50" class="textarea-remarks-readonly" style="height: 102px"><?=$data_sales[0]['s_notes'];?></textarea>
            </div> 
            <div class="col-lg-6">
        ...
        <div class="col-lg-4">     
            ...
            <div class="col-lg-7"><span class="label-block align-text">Dowpayment Type</span></div>
            <div class="col-lg-5">
                <select disabled name="s_downpayment_type" id="s_downpayment_type" class="field_readonly_block">
                    <?php
                        if($data_sales[0]['s_downpayment_type']=="N") {
                            echo "<option value='N' selected>Single</option>";
                            echo "<option value='S'>Split</option>";
                        } else {
                            echo "<option value='N'>Single</option>";
                            echo "<option value='S' selected>Split</option>";
                        }
                    ?>
                </select>
            </div>
            ...
            <div class="col-lg-7"><span class="label-block align-text">First Month Due Date</span></div>
            <div class="col-lg-5"><input disabled name="s_firstmonthlydue_date" type="text" value="<?=date('m/d/Y',strtotime($data_sales[0]['s_firstmonthlydue_date']));?>" class="field_readonly_block"></div>
            <div class="col-lg-7"><span class="label-block align-text">First Downpayment</span></div>
            <div class="col-lg-5"><input disabled name="s_firstdownpayment" type="number" value="<?=$data_sales[0]['s_firstdownpayment'];?>" class="field_readonly_block"></div>
            <div class="col-lg-7"><span class="label-block align-text">Due Date</span></div>
            <div class="col-lg-5"><input disabled name="s_firstdownpayment_date" type="text" value="<?=date('m/d/Y',strtotime($data_sales[0]['s_firstdownpayment_date']));?>" class="field_readonly_block"></div>
            <div class="col-lg-7"><span class="label-block align-text">Second Downpayment</span></div>
            <div class="col-lg-5"><input disabled name="s_seconddownpayment" type="number" value="<?=$data_sales[0]['s_seconddownpayment'];?>" class="field_readonly_block"></div>
            <div class="col-lg-7"><span class="label-block align-text">Due Date</span></div>
            <div class="col-lg-5"><input disabled name="s_seconddownpayment_date" type="text" value="<?=date('m/d/Y',strtotime($data_sales[0]['s_seconddownpayment_date']));?>" class="field_readonly_block"></div>
            <div class="col-lg-7"><span class="label-block align-text">Monthly</span></div>
            <div class="col-lg-5"><input disabled name="s_monthlyamortization" type="number" value="<?=$monthly;?>" class="field_readonly_block"></div>
...
<div class="form-footer">
    ...
    <?php if($s_paid=="N") { ?>
    <button data-salesid="<?=$s_id;?>" class="form-button"><i class="fa fa-street-view" aria-hidden="true"></i></i> Assume</button>
    <button data-salesid="<?=$s_id;?>" class="form-button"><i class="fa fa-retweet" aria-hidden="true"></i> Reconstuct</button>
    <?php } ?>    
    <button closewindow="off" class="form-button view-payments"><i class="fa fa-money" aria-hidden="true"></i> Collections</button>
    <button closewindow="off" class="form-button payment-schedule"><i class="fa fa-calendar" aria-hidden="true"></i> Payment Schedule</button>

    ...
    <form id="form_sales"> 
        ...
        <div class="col-lg-8">
            ...
            <div class="col-lg-12">
                ...
                <textarea name="s_notes" rows="4" cols="50" class="textarea-remarks-input" style="height: 100px"><?=$data_sales[0]['s_notes'];?></textarea>
            </div> 
        </div>        
        <div class="col-lg-4">     
...
<div class="form-footer">
    <button closewindow="off" class="form-button add-item"><i class="fa fa-plus" aria-hidden="true"></i> Add Items</button>
    <button closewindow="off" class="form-button remove-item"><i class="fa fa-minus" aria-hidden="true"></i> Delete Items</button>
    <button closewindow="off" class="form-button update-sales-sp-cash"><i class="fa fa-floppy-o" aria-hidden="true"></i> Update</button>
    ...
    $("#dbgrid-spareparts").jsGrid({
        ...
        fields: [
            {   
                ...
                itemTemplate: function(value,e) { return $("<div>").append('<div><input type="radio" name="selected-spareparts" value="'+e.s_sub_id+'"></div>'); },
            },  

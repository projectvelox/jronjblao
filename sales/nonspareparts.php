    ...
    $("#dbgrid").jsGrid({
        ...
        fields: [
            {   
                ...
                itemTemplate: function(value,e) { 
                    if(e.s_confirm=="Y"){
                        ...
                        return $("<div>").append('<button data-id="'+e.s_id+'" closewindow="off" class="form-button-recieved post-sales">POST</button>'); 
                    }
                },
            },  
            {   
                ...
                itemTemplate: function(value,e) { 
                    if(e.s_confirm=="Y"){
                        ...
                        return $("<div>").append('<span data-salestype="'+e.s_sales_type+'" data-id="'+e.s_id+'" class="grid-link sales-edit-nonsp">'+e.s_no+'</span>'); 
                    }
                },
            },  
            ...
            {   
                ...
                itemTemplate: function(value,e) { 
                    return $("<div>").append('<span data-id="'+e.s_product_id+'" class="grid-link view_stock">'+e.s_po_no+'</span>'); 
                },
            }, 

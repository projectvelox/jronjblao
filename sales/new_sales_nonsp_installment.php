    ...
    <form id="form_sales"> 
        ...
        <div class="col-lg-8">
            ...
            <div class="col-lg-3">
                ...
                <input name="s_sales_type" type="hidden" value="I" class="field-input-block-thin">
                <input disabled name="s_sales_type_text" type="text" value="Installment" class="field_readonly_block">
            </div>         
            <div class="col-lg-6">
            ...
            <div class="col-lg-4">
                <span class="label-block">Tax</span>
                <input name="s_tax" type="number" value="0" class="field-input-block-thin">
            </div>  
            <div class="col-lg-4">
                <span class="label-block">Other Charges</span>
                <input name="s_othercharges" type="number" value="0" class="field-input-block-thin">
            </div>  
            <div class="col-lg-4">
                <span class="label-block">Discount</span>
                <input name="s_discount" type="number" value="0" class="field-input-block-thin">
            </div>  
            <div class="col-lg-12">
                <span class="label-block">Notes</span>
                <textarea name="p_notes" rows="4" cols="50" class="textarea-remarks-input" style="height: 208px"></textarea>
            </div> 
        </div>        
        <div class="col-lg-4">     
            ...
            <div class="col-lg-5"><input disabled name="s_deliverydate" type="text" value="" class="field_readonly_block"></div>
...
<div class="form-footer">
    <button closewindow="off" class="form-button create-sales-nonsp-installment"><i class="fa fa-plus" aria-hidden="true"></i> Create</button>

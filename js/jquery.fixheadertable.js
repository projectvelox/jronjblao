	...
	$.fn.fixheadertable = function(options) {
		...
		return this.each(function() {
			...
			function buildHeaders(table) {
				...
				tab_headers.addClass('tableheader');
			...
			function restrictRows(table, nbrows) {
				...
				$('tr:last td', table).css('border-bottom-width', '11px');
			}
			...
			_main_wrapper = $('<div class="t_fixed_header_main_wrapper ui-widget' + options.theme + '"></div>');
			...
			if(options.wrapper){
				...
				var tampon = _wrapper.wrap('<div class="ui-widget ui-widget-content ui-corner-all" style="padding : 0px; font-size : 1em;"></div>').parent();

...
<?php 
    ...
    $query_main = "SELECT *,
                ...
                FROM po_main WHERE p_status='D' ORDER BY p_requestdate ASC";
    ...
    while ($row_main = mysql_fetch_array($recordset_main, MYSQL_ASSOC)) {
        ...
        $data .= '{
            ...
            "p_requestdate":"'.date('m/d/Y',strtotime($row_main['p_requestdate'])).'",
    ...
    $("#dbgrid").jsGrid({
        ...
        fields: [
            ...
            {   
                ...
                itemTemplate: function(value,e) { return $("<div>").append('<div><span data-id="'+e.p_id+'" class="grid-link po-edit">'+e.p_no+'</span></div>'); },                
            }, 
            {name:"p_requestdate", type:"text", width:"100px", title:"REQUEST", align:"center"},

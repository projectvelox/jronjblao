...
<?php 
    ...
    $query_main = "SELECT *,
                ...
                FROM po_main WHERE p_status='R' ORDER BY p_requestdate ASC";
    ...
    while ($row_main = mysql_fetch_array($recordset_main, MYSQL_ASSOC)) {
        ...
        $data .= '{
            ...
            "recieved_date":"'.date('m/d/Y',strtotime($row_main['recieved_date'])).'",
    ...
    $("#dbgrid").jsGrid({
        ...
        fields: [
            {   
                ...
                itemTemplate: function(value,e) { return $("<div>").append('<div><i class="fa fa-check" aria-hidden="true"></i></div>'); },
            },
            {   
            ...
            {name:"recieved_date", type:"text", width:"100px", title:"RECEIVED", align:"center"},

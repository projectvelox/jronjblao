...
<?php 
    ...
    $query_main = "SELECT *,
                ...
                FROM po_main WHERE p_status='A' ORDER BY p_requestdate ASC";
    ...
    while ($row_main = mysql_fetch_array($recordset_main, MYSQL_ASSOC)) {
        ...
        $data .= '{
            ...
            "approval_date":"'.date('m/d/Y',strtotime($row_main['approval_date'])).'",
...
<script>
    $("#dbgrid").jsGrid({
        ...
        fields: [
            ...
            {name:"approval_date", type:"text", width:"100px", title:"APPROVAL", align:"center"},
